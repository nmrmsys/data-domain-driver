...
module.exports = class DataSet {
    ...
    toJSON(
        ...
        if (typeof mainDataDef != 'undefined') {
            ...
            if(typeOf(srcDat) == 'resultset'){
                _.each(srcDat.rows, (row) => {
                ...
                _.each(relationDefs, (def, name) => {
                    srcDat[name] = this._getRelationData(def, srcDat, keyName);
                });
            }
    ...
    toObject(
        ...
        if (typeof mainDataDef != 'undefined') {
            ...
            return Utils.toObject(srcDat, [className, dataName, keyName]);
        } else {
